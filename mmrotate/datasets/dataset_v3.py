...
class Datasetv3Dataset(CustomDataset):
    ...
    """
    CLASSES = ('normal','hotspot','diode','string','extended','delamination','multiple_hotspot')
    ...
    def __init__(self,
        ...
        super(Datasetv3Dataset, self).__init__(ann_file, pipeline, **kwargs)
